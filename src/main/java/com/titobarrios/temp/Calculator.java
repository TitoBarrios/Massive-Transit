...
public class Calculator {
	private Archive dataCenter;

	public Calculator() {
		dataCenter = new Archive();
	}
	...
	// Ordenado (Mirar si se pueden reducir líneas)
	...
	// Ordenado, ya no revisa la disponibilidad de la ruta
	...
	// Ordenado, menos condiciones, no revisa si es nulo o no
	...
	// Ordenado, sin revisar: NECESARIO REVISAR
	...
	public LocalDateTime setLaboralDays(DayOfWeek[] laboralDays, LocalDateTime time) {
		...
		while (!isDayForWork) {currentDate
